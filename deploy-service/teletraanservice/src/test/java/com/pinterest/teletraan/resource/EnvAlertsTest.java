...
public class EnvAlertsTest {
    ...
    public void setUp() throws Exception {
        ...
        when(environDAO.getByStage(environBean.getEnv_name(), environBean.getStage_name()))
                .thenReturn(environBean);
        ...
        when(sc.getUserPrincipal())
                .thenReturn(
                        new UserPrincipal(Constants.AUTO_PROMOTER_NAME, new ArrayList<String>()));
